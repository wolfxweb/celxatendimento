...
=========================== logs ===========================
waiting for navigation to "**/dashboard/cliente/tickets" until "load"
  navigated to "http://localhost:3001/dashboard/cliente/tickets/novo"
============================================================
```
            ...
            - generic [ref=e46]:
              - generic [ref=e47]:
                ...
                - textbox "Assunto *" [ref=e49]:
                  ...
                  - text: Test Ticket Subject E2E 1776981298306
                - generic [ref=e50]: 37/200
              - generic [ref=e51]:
