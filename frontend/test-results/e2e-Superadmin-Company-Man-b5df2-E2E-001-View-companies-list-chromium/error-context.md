...
- Name: e2e.spec.ts >> Superadmin Company Management >> COMP-E2E-001: View companies list
- Location: tests/e2e.spec.ts:290:7
...
Locator: locator('text=Empresas')
Expected: visible
Error: strict mode violation: locator('text=Empresas') resolved to 3 elements:
    1) <span class="font-medium group-hover:text-primary-400 transition-colors">Empresas</span> aka getByRole('link', { name: '🏢 Empresas' })
    2) <span class="bg-clip-text text-transparent bg-gradient-to-r from-slate-800 to-primary-600">Gerenciar Empresas</span> aka getByText('Gerenciar Empresas', { exact: true })
    3) <p class="text-slate-500 mt-1">Aprovar e gerenciar empresas do sistema</p> aka getByText('Aprovar e gerenciar empresas')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Empresas')
  ...
  - generic [ref=e2]:
    ...
    - generic [ref=e31]:
      ...
      - main [ref=e41]:
        - generic [ref=e43]:
          - generic [ref=e44]:
            - heading "Gerenciar Empresas" [level=1] [ref=e45]
            - paragraph [ref=e46]: Aprovar e gerenciar empresas do sistema
          - generic [ref=e47]:
            - button "⏳ Pendente" [ref=e48] [cursor=pointer]:
              - generic [ref=e49]: ⏳
              - text: Pendente
            - button "✓ Ativas" [ref=e50] [cursor=pointer]:
              - generic [ref=e51]: ✓
              - text: Ativas
            - button "⏸ Suspensas" [ref=e52] [cursor=pointer]:
              - generic [ref=e53]: ⏸
              - text: Suspensas
            - button "📋 Todas" [ref=e54] [cursor=pointer]:
              - generic [ref=e55]: 📋
              - text: Todas
          - generic [ref=e56]: Erro ao carregar empresas
          - generic [ref=e57]:
            - generic [ref=e58]: 🏢
            - heading "Nenhuma empresa encontrada" [level=3] [ref=e59]
  - alert [ref=e60]
```
