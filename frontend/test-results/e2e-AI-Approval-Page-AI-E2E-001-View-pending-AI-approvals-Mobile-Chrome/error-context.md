...
- Name: e2e.spec.ts >> AI Approval Page >> AI-E2E-001: View pending AI approvals
- Location: tests/e2e.spec.ts:149:7
...
Locator: getByRole('heading', { name: /aprova/i, level: 1 })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: /aprova/i, level: 1 })
...
- generic [active] [ref=e1]:
  - generic [ref=e2]:
    ...
    - generic [ref=e32]:
      ...
      - main [ref=e42]:
        - generic [ref=e44]: Erro ao carregar dados
  - alert [ref=e45]
```
